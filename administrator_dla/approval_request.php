                      ...
                      <form method="POST" action="">
                        <table id="check" class="table table-striped table-bordered table-hover" style="width:100%">
                          ...
                          <?php 
                            ...
                            $query = "SELECT * FROM request_material WHERE status = 'Purchase Order Posted' ORDER BY id DESC";
                                          ...
                                          <div class="row">
                                            <div class="col-md-12">
                                              <div class="form-group">
                                                ...
                                                <input type="radio" name="status" value="Purchase Order Approved (1)" required> Purchase Order Approved<br/>
                                                <input type="radio" name="status" value="Purchase Order Disapproved (1)"> Purchase Order Disapproved
                                              </div>
                                            </div>
                                          </div>
                                          <div class="row">
