                    ...
                    <form method="POST" action="">
                      <table id="check" class="table table-striped table-bordered table-hover" style="width:100%">
                        ...
                        <?php 
                          ...
                          $query = mysqli_query($conn, "SELECT * FROM request_material WHERE status = 'Cash Request Posted' ORDER BY id DESC");
                          $i = 1;
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <div class="row">
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label>APPROVAL REQUEST <em class="text-danger">*required</em></label>
                                        <select class="form-control" required="required" name="status" id="selection">
                                          <option selected="true" disabled="true">SELECT APPROVAL REQUEST</option>
                                          <option value="Cash Request Approved">Cash Request Approved</option>
                                          <option value="Cash Request Disapproved">Cash Request Disapproved</option>
                                        </select>
                                      </div>
                                    </div>
                                    <div class="col-md-6">
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                      <input type="checkbox" class="read-more-state" id="post-2"> VIEW CASH REQUEST<br/><br/>
                                ...
                                <div class="modal-footer">
                                  <input type="submit" name="btn_request" value="SUBMIT REQUEST" class="btn btn-primary">
