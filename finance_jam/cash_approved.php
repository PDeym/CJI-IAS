              ...
              <div class="card">
                <div class="card-body">
                  ...
                  if (isset($_POST['btn_released'])) {
                    ...
                    $query = mysqli_query($conn, "UPDATE request_material SET requestor = '$requestor', dateTime = '$dateTime', status = '$status' WHERE id = '$id' ");
                    ...
                    <form method="POST" action="">
                      <table id="check" class="table table-striped table-bordered table-hover" style="width:100%">
                        ...
                        <?php 
                          ...
                          $query = mysqli_query($conn, "SELECT * FROM request_material WHERE status = 'Cash Request Approved' ORDER BY id DESC");
                          $i = 1;
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td><label class="badge badge-info"><?php echo $row['status']; ?></label></td>
                              ...
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel">
                                    Cash Requested by: <b><?php echo $row['location']; ?> / <?php echo $row['requestor']; ?></b>
                                  </h5>
                                ...
                                <div class="modal-body">
                                  <div class="row">
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        ...
                                        <input type="hidden" name="status" class="form-control" value="Cash Released" readonly>
                                        <input type="text" name="" class="form-control" value="<?php echo $row['status']; ?>" readonly>
                                      </div>
                                    </div>
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label>Purchaser</label>
                                        <input type="text" class="form-control" name="purchaser" value="<?php echo $row['purchaser']; ?>" readonly>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="row">
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                      <input type="checkbox" class="read-more-state" id="post-2"> REVIEW ITEM/CASH<br/><br/>
                                        ...
                                        <div class="row">
                                          <div class="col-md-6">
                                            <div class="form-group read-more-target">
                                              <h3 id="text_total">TOTAL CASH REQUEST</h3>
                                            </div>
                                          </div>
                                          <div class="col-md-6">
                                            <div class="form-group">
                                              <input type="text" id="total_request" name="cash_request" class="form-control read-more-target" value="<?php echo $row['cash_request']; ?>"/>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                ...
                                <div class="modal-footer">
                                  <input type="submit" name="btn_released" value="CASH RELEASED" class="btn btn-primary">
