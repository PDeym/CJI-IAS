                ...
                <div class="card">
                  <div class="card-body">
                    <h3 class="text-dark font-weight-bold mb-2">
                      Item to Released (From Purchased)
                    </h3><br/>
                      ...
                      <form method="POST" action="">
                        <table id="check" class="table table-striped table-bordered table-hover" style="width:100%">
                          ...
                          <?php 
                            ...
                            $query = "SELECT * FROM request_material WHERE status = 'Item Delivered to Warehouse'ORDER BY id DESC";
                                ...
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h3 class="modal-title" id="exampleModalLabel">ITEM TO RELEASE</h3>
                                      ...
                                      <div class="row">
                                        <div class="col-md-12">
                                          <div class="form-group">
                                            ...
                                            <input type="hidden" name="status" class="form-control" value="Item Released" readonly>
                                    ...
                                    <div class="modal-footer">
                                      <input type="submit" class="btn btn-primary" name="btn_release" value="RELEASED ITEM">
                        ...
                        <table id="checkRelease" class="table table-striped table-bordered table-hover" style="width:100%">
                          <thead>
                            <tr>
                              <th>TRANSACTION NO.</th>
                              <th>ITEM DESCRIPTION</th>
                            ...
                            ?>
                              <tbody>
                                <tr>
                                  ...
                                  <td><?php echo $row['dateTime']; ?></td>
                                  <td>
                                    <a href="view_released.php?transaction_no=<?php echo $row['transaction_no']; ?>" class="btn btn-success">
