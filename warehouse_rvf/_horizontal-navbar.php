      ...
      <nav class="bottom-navbar">
        <div class="container">
            <ul class="nav page-navigation">
              ...
              <li class="nav-item">
                  <a href="add_materials.php" class="nav-link">
                    <i class="mdi mdi-plus menu-icon"></i>
                    <span class="menu-title">Inventory Materials</span>
              ...
              <li class="nav-item">
                  <a href="item_released.php" class="nav-link">
                    <i class="mdi mdi-information-variant menu-icon"></i>
                    <span class="menu-title">Item to Release</span>
                    <i class="menu-arrow"></i>
                  </a>
              </li>
              <li class="nav-item">
