                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    if (isset($_POST['btn_submit'])) {
                      ...
                      $item_code3 = $_POST['item_code3'];
                      $item_code4 = $_POST['item_code4'];
                      $item_code5 = $_POST['item_code5'];
                      $item_code6 = $_POST['item_code6'];
                      $item_code7 = $_POST['item_code7'];
                      $item_code8 = $_POST['item_code8'];
                      $item_code9 = $_POST['item_code9'];
                      $item_code10 = $_POST['item_code10'];
                      $purpose = $_POST['purpose'];
                      $project_no = $_POST['project_no'];
                      $status = $_POST['status'];

                      $query = mysqli_query($conn, "INSERT INTO request_material (requestor, location, dateTime, transaction_no, material_requested1, quantity1, material_requested2, quantity2, material_requested3, quantity3, material_requested4, quantity4, material_requested5, quantity5, material_requested6, quantity6, material_requested7, quantity7, material_requested8, quantity8, material_requested9, quantity9, material_requested10, quantity10, item_code1, item_code2, item_code3, item_code4, item_code5, item_code6, item_code7, item_code8, item_code9, item_code10, status, purpose, project_no) VALUES ('$requestor', '$location', '$dateTime', '$transaction_no', '$material_requested1', '$quantity1', '$material_requested2', '$quantity2', '$material_requested3', '$quantity3', '$material_requested4', '$quantity4', '$material_requested5', '$quantity5', '$material_requested6', '$quantity6', '$material_requested7', '$quantity7', '$material_requested8', '$quantity8', '$material_requested9', '$quantity9', '$material_requested10', '$quantity10', '$item_code1', '$item_code2', '$item_code3', '$item_code4', '$item_code5', '$item_code6', '$item_code7', '$item_code8', '$item_code9', '$item_code10', '$status', '$purpose', '$project_no')");
                      
                      $query_transaction = mysqli_query($conn, "INSERT INTO transaction_history (requestor, location, dateTime, transaction_no, material_requested1, quantity1, material_requested2, quantity2, material_requested3, quantity3, material_requested4, quantity4, material_requested5, quantity5, material_requested6, quantity6, material_requested7, quantity7, material_requested8, quantity8, material_requested9, quantity9, material_requested10, quantity10, item_code1, item_code2, item_code3, item_code4, item_code5, item_code6, item_code7, item_code8, item_code9, item_code10, status, project_no) VALUES ('$requestor', '$location', '$dateTime', '$transaction_no', '$material_requested1', '$quantity1', '$material_requested2', '$quantity2', '$material_requested3', '$quantity3', '$material_requested4', '$quantity4', '$material_requested5', '$quantity5', '$material_requested6', '$quantity6', '$material_requested7', '$quantity7', '$material_requested8', '$quantity8', '$material_requested9', '$quantity9', '$material_requested10', '$quantity10', '$item_code1', '$item_code2', '$item_code3', '$item_code4', '$item_code5', '$item_code6', '$item_code7', '$item_code8', '$item_code9', '$item_code10', '$status', '$project_no')");
                    }
                    mysqli_close($conn);
                    ?>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <textarea name="purpose" rows="4" class="form-control"></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            <label><b>List of Project No.</b></label>
                            <select class="form-control" name="project_no" style="padding: 13px;" required="true">
                              <option selected="true" disabled="true">Select Available Project #</option>
                              <?php 
                              include '../auth/connection.php';
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <div class="form-group read-more-wrap">
                            <div class="row">
                              <div class="col-md-2">
                                <select class="form-control" name="item_code1" style="padding: 13px;">
                                  <option selected="true" disabled="true">Select Type of Code</option>
                              ...
                              <div class="col-md-2">
                                <select class="form-control" name="item_code2" style="padding: 13px;">
                                  <option selected="true" disabled="true">Select Type of Code</option>
                                  <option value="01001 – Electrical Items">01001 – Electrical Items</option>
                                  <option value="02001 – Welding Items">02001 – Welding Items</option>
                                </select>
                            ...
                            <div class="row">
                              <div class="col-md-2">
                                <select class="form-control" name="item_code3" style="padding: 13px;">
                                  <option selected="true" disabled="true">Select Type of Code</option>
                                  <option value="01001 – Electrical Items">01001 – Electrical Items</option>
                                  <option value="02001 – Welding Items">02001 – Welding Items</option>
                                </select>
                              ...
                              <div class="col-md-2">
                                <select class="form-control" name="item_code4" style="padding: 13px;">
                                  <option selected="true" disabled="true">Select Type of Code</option>
                                  <option value="01001 – Electrical Items">01001 – Electrical Items</option>
                                  <option value="02001 – Welding Items">02001 – Welding Items</option>
                                </select>
                            ...
                            <div class="row">
                              <div class="col-md-2">
                                <select class="form-control read-more-target" name="item_code5" style="padding: 13px;">
                                  <option selected="true" disabled="true">Select Type of Code</option>
                                  <option value="01001 – Electrical Items">01001 – Electrical Items</option>
                                  <option value="02001 – Welding Items">02001 – Welding Items</option>
                                </select>
                              ...
                              <div class="col-md-2">
                                <select class="form-control read-more-target" name="item_code6" style="padding: 13px;">
                                  <option selected="true" disabled="true">Select Type of Code</option>
                                  <option value="01001 – Electrical Items">01001 – Electrical Items</option>
                                  <option value="02001 – Welding Items">02001 – Welding Items</option>
                                </select>
                            ...
                            <div class="row">
                              <div class="col-md-2">
                                <select class="form-control read-more-target" name="item_code7" style="padding: 13px;">
                                  <option selected="true" disabled="true">Select Type of Code</option>
                                  <option value="01001 – Electrical Items">01001 – Electrical Items</option>
                                  <option value="02001 – Welding Items">02001 – Welding Items</option>
                                </select>
                              ...
                              <div class="col-md-2">
                                <select class="form-control read-more-target" name="item_code8" style="padding: 13px;">
                                  <option selected="true" disabled="true">Select Type of Code</option>
                                  <option value="01001 – Electrical Items">01001 – Electrical Items</option>
                                  <option value="02001 – Welding Items">02001 – Welding Items</option>
                                </select>
                            ...
                            <div class="row">
                              <div class="col-md-2">
                                <select class="form-control read-more-target" name="item_code9" style="padding: 13px;">
                                  <option selected="true" disabled="true">Select Type of Code</option>
                                  <option value="01001 – Electrical Items">01001 – Electrical Items</option>
                                  <option value="02001 – Welding Items">02001 – Welding Items</option>
                                </select>
                              ...
                              <div class="col-md-2">
                                <select class="form-control read-more-target" name="item_code10" style="padding: 13px;">
                                  <option selected="true" disabled="true">Select Type of Code</option>
                                  <option value="01001 – Electrical Items">01001 – Electrical Items</option>
                                  <option value="02001 – Welding Items">02001 – Welding Items</option>
                                </select>
                            ...
                            <div class="row read-more-target">
                              <div class="col-md-12">
                                <div class="form-group">
                                  <h3 class="text-danger text-center"><em>(Note: The Material Request is <b>fixed to 10 Items</b> per transaction number/transaction.)</em></h3>
                                </div>
                              </div>
                            </div>
                          </div>
