      ...
      <nav class="bottom-navbar">
        <div class="container">
            <ul class="nav page-navigation">
              ...
              <li class="nav-item">
                <a href="cash_released.php" class="nav-link">
                  <i class="mdi mdi-check menu-icon"></i>
                  <span class="menu-title">Check Purchasing Material</span>
                  <i class="menu-arrow"></i>
                </a>
              </li>
              <li class="nav-item">
                <a href="delivery_materials.php" class="nav-link">
                  <i class="mdi mdi-package-variant menu-icon"></i>
                  <span class="menu-title">Ready to Deliver of Materials</span>
                  <i class="menu-arrow"></i>
                </a>
              </li>
              <li class="nav-item">
