                      ...
                      <form method="POST" action="">
                        <table id="check" class="table table-striped table-bordered table-hover" style="width:100%">
                          ...
                          <?php 
                            ...
                            $query = "SELECT * FROM request_material WHERE status = 'Purchasing Item' ORDER BY id DESC";
                                ...
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="row">
                                        <div class="col-md-12">
                                          <div class="form-group">
                                            ...
                                            <input type="hidden" name="status" class="form-control" value="Delivery of Materials" readonly>
                                    ...
                                    <div class="modal-footer">
                                      <input type="submit" class="btn btn-primary" name="btn_purchase" value="DELIVER TO WAREHOUSE(RMA)">
