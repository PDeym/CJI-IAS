          ...
          <div class="container">
                    ...
                    <h3 class="text-dark font-weight-bold mb-2">Hi <?php echo $_SESSION['user']['name']; ?>, welcome back!</h3><br/>
                        ...
                        if (isset($_POST['btn_change'])) {
                          ...
                          $query = mysqli_query($conn, "UPDATE credentials SET name = '$name', username = '$username', password = '$password', confirmpassword = '$confirmpassword' WHERE group_id = 'Warehouse_RMA' ");
                        }
                        mysqli_close($conn);
                        ...
                        <?php endif ?>
                          ...
                          <form action="" method="POST">
                            ...
                            $query = "SELECT * FROM credentials WHERE group_id = 'Warehouse_RMA' ";
