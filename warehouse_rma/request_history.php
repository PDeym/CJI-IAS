                          ...
                          ?>
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <label class="badge badge-success"><?php echo $row['item_code1']; ?></label> 
                                  <?php echo $row['quantity1']; ?>
                                  <?php echo $row['material_requested1']; ?> <br/>
                                  <label class="badge badge-success"><?php echo $row['item_code2']; ?></label> 
                                  <?php echo $row['quantity2']; ?>
                                  <?php echo $row['material_requested2']; ?> <br/>
                                  <label class="badge badge-success"><?php echo $row['item_code3']; ?></label> 
                                  <?php echo $row['quantity3']; ?>
                                  <?php echo $row['material_requested3']; ?> <br/>
                                  <label class="badge badge-success"><?php echo $row['item_code4']; ?></label> 
                                  <?php echo $row['quantity4']; ?>
                                  <?php echo $row['material_requested4']; ?> <br/>
                                  <label class="badge badge-success"><?php echo $row['item_code5']; ?></label> 
                                  <?php echo $row['quantity5']; ?>
                                  <?php echo $row['material_requested5']; ?> <br/>
                                  <label class="badge badge-success"><?php echo $row['item_code6']; ?></label> 
                                  <?php echo $row['quantity6']; ?>
                                  <?php echo $row['material_requested6']; ?> <br/>
                                  <label class="badge badge-success"><?php echo $row['item_code7']; ?></label> 
                                  <?php echo $row['quantity7']; ?>
                                  <?php echo $row['material_requested7']; ?> <br/>
                                  <label class="badge badge-success"><?php echo $row['item_code8']; ?></label> 
                                  <?php echo $row['quantity8']; ?>
                                  <?php echo $row['material_requested8']; ?> <br/>
                                  <label class="badge badge-success"><?php echo $row['item_code9']; ?></label> 
                                  <?php echo $row['quantity9']; ?>
                                  <?php echo $row['material_requested9']; ?> <br/>
                                  <label class="badge badge-success"><?php echo $row['item_code10']; ?></label> 
                                  <?php echo $row['quantity10']; ?>
                                  <?php echo $row['material_requested10']; ?> 
                                </td>
                                <td><?php echo $row['dateTime']; ?></td>
                                <td><a href="request_singleHistory.php?transaction_no=<?php echo $row['transaction_no']; ?>" class="btn btn-success"><i class="mdi mdi-eye"></i></a></td>
                              </tr>
                            </tbody>
                          <?php } ?>
                        </table>
