            ...
            <ul class="nav page-navigation">
              ...
              <li class="nav-item">
                  <a href="check_availability.php" class="nav-link">
                    ...
                    <span class="menu-title">Check Request</span>
                    <i class="menu-arrow"></i>
                  </a>
              </li>
              <li class="nav-item">
                  <a href="purchase_approved.php" class="nav-link">
                    <i class="mdi mdi-package-variant menu-icon"></i>
                    <span class="menu-title">Approved Purchase Order</span>
                    <i class="menu-arrow"></i>
                  </a>
              </li>
              <li class="nav-item">
                  <a href="incoming_material.php" class="nav-link">
                    <i class="mdi mdi-information-variant menu-icon"></i>
                    <span class="menu-title">Incoming Material</span>
                    <i class="menu-arrow"></i>
                  </a>
              </li>
              <li class="nav-item">
