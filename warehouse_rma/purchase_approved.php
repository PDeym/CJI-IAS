		...
		<div class="container-fluid page-body-wrapper">
          ...
          <div class="container">
                    ...
                    if (isset($_POST['btn_purchase'])) {
                      ...
                      $_SESSION['success'] = "SUCCESSFULLY TRANSMIT TO FINANCE!";
                      ...
                      <form method="POST" action="">
                        <table id="check" class="table table-striped table-bordered table-hover" style="width:100%">
                          ...
                          <?php 
                            ...
                            $query = "SELECT * FROM request_material WHERE status = 'Purchase Order Approved (2)' ORDER BY id DESC";
                                  ...
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h5 class="modal-title" id="exampleModalLabel">
                                        Approved Request by: <b><?php echo $row['location']; ?> / <?php echo $row['requestor']; ?></b>
                                      </h5>
                                    ...
                                    <div class="modal-body">
                                      <div class="row">
                                        ...
                                        <input type="hidden" class="form-control" name="status" readonly value="Transmittal to Finance">
                                    ...
                                    <div class="modal-footer">
                                      <input type="submit" name="btn_purchase" value="TRANSMIT TO FINANCE" class="btn btn-primary">
